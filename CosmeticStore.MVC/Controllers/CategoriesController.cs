...
namespace CosmeticStore.MVC.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(CosmeticStoreContext context)
        {
            _context = context;
        }
        ...
        {
            var cosmeticStoreContext = _context.Categories.Include(c => c.ParentCategory);
            return View(await cosmeticStoreContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CosmeticStoreContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
